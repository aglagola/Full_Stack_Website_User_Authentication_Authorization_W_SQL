...
Partial Class Default7
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Label1.Text = GetDistance(lat1, lon1, lat2, lon2, "M")
    End Sub
    ...
    Function GetDistance(ByVal lat1 As Double, ByVal lon1 As Double, ByVal lat2 As Double, ByVal lon2 As Double, ByVal unit As String) As Double
